...
so a group reads the same way in both.
  ...
  symbolic verification: total
       32  proved (structural) [sampled 4]
        1  unproved (over max_rounds) [sampled 4]
     1643  unproved (too large)
      972  unproved (unbound constant) [sampled 4]
      115  vacuous
  graph
  inputs:
  ...
  nodes:
    ...
    group g6 torch.ops.aten.convolution.default:
      ...
      n22 {derived verify=unproved (too large)}: [t145 f32 [H=56 W=56 C=64] {derived verify=unproved (too large) origins=2} ->[n25]] =
        convolution
          x=t298 {derived verify=unproved (too large)} <-n177
    ...
    group g8 torch.ops.aten.convolution.default:
      ...
      n31 {derived verify=unproved (too large)}: [t154 f32 [H=56 W=56 C=64] {derived verify=unproved (too large) origins=2} ->[n34]] =
        convolution
          x=t300 {derived verify=unproved (too large)} <-n179
    ...
    group g10 torch.ops.aten.convolution.default:
      ...
      n39 {derived verify=unproved (too large)}: [t162 f32 [H=56 W=56 C=64] {derived verify=unproved (too large) origins=2} ->[n42]] =
        convolution
          x=t301 {derived verify=unproved (too large)} <-n180
    ...
    group g12 torch.ops.aten.convolution.default:
      ...
      n48 {derived verify=unproved (too large)}: [t171 f32 [H=28 W=28 C=128] {derived verify=unproved (too large) origins=2} ->[n51]] =
        convolution
          x=t303 {derived verify=unproved (too large) origins=2} <-n182
    ...
    group g14 torch.ops.aten.convolution.default:
      ...
      n56 {derived verify=unproved (too large)}: [t179 f32 [H=28 W=28 C=128] {derived verify=unproved (too large) origins=2} ->[n59]] =
        convolution
          x=t304 {derived verify=unproved (too large)} <-n183
    ...
    group g18 torch.ops.aten.convolution.default:
      ...
      n72 {derived verify=unproved (too large)}: [t195 f32 [H=28 W=28 C=128] {derived verify=unproved (too large) origins=2} ->[n75]] =
        convolution
          x=t306 {derived verify=unproved (too large)} <-n185
    ...
    group g20 torch.ops.aten.convolution.default:
      ...
      n80 {derived verify=unproved (too large)}: [t203 f32 [H=28 W=28 C=128] {derived verify=unproved (too large) origins=2} ->[n83]] =
        convolution
          x=t307 {derived verify=unproved (too large)} <-n186
    ...
    group g22 torch.ops.aten.convolution.default:
      ...
      n89 {derived verify=unproved (too large)}: [t212 f32 [H=14 W=14 C=256] {derived verify=unproved (too large) origins=2} ->[n92]] =
        convolution
          x=t309 {derived verify=unproved (too large) origins=2} <-n188
    ...
    group g24 torch.ops.aten.convolution.default:
      ...
      n97 {derived verify=unproved (too large)}: [t220 f32 [H=14 W=14 C=256] {derived verify=unproved (too large) origins=2} ->[n100]] =
        convolution
          x=t310 {derived verify=unproved (too large)} <-n189
    ...
    group g28 torch.ops.aten.convolution.default:
      ...
      n113 {derived verify=unproved (too large)}: [t236 f32 [H=14 W=14 C=256] {derived verify=unproved (too large) origins=2} ->[n116]] =
        convolution
          x=t312 {derived verify=unproved (too large)} <-n191
    ...
    group g30 torch.ops.aten.convolution.default:
      ...
      n121 {derived verify=unproved (too large)}: [t244 f32 [H=14 W=14 C=256] {derived verify=unproved (too large) origins=2} ->[n124]] =
        convolution
          x=t313 {derived verify=unproved (too large)} <-n192
    ...
    group g32 torch.ops.aten.convolution.default:
      ...
      n130 {derived verify=unproved (too large)}: [t253 f32 [H=7 W=7 C=512] {derived verify=unproved (too large) origins=2} ->[n133]] =
        convolution
          x=t315 {derived verify=unproved (too large) origins=2} <-n194
    ...
    group g34 torch.ops.aten.convolution.default:
      ...
      n138 {derived verify=unproved (too large)}: [t261 f32 [H=7 W=7 C=512] {derived verify=unproved (too large) origins=2} ->[n141]] =
        convolution
          x=t316 {derived verify=unproved (too large)} <-n195
    ...
    group g38 torch.ops.aten.convolution.default:
      ...
      n154 {derived verify=unproved (too large)}: [t277 f32 [H=7 W=7 C=512] {derived verify=unproved (too large) origins=2} ->[n157]] =
        convolution
          x=t318 {derived verify=unproved (too large)} <-n197
    ...
    group g40 torch.ops.aten.convolution.default:
      ...
      n162 {derived verify=unproved (too large)}: [t285 f32 [H=7 W=7 C=512] {derived verify=unproved (too large) origins=2} ->[n165]] =
        convolution
          x=t319 {derived verify=unproved (too large)} <-n198
    ...
    group g3 torch.ops.aten.max_pool2d_with_indices.default:
      n176 {derived verify=unproved (too large)}: [t132 f32 [H=56 W=56 C=64] {derived verify=unproved (too large) origins=2} ->[n14,
                                                                      n178]] =
        max_pool2d
    ...
    group g5 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n17 {derived verify=unproved (too large)}: [t140 f32 [H=56 W=56 C=64] {derived verify=unproved (too large)} ->[n177]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n177 {pt2=root[6] torch.ops.aten.relu.default verify=unproved (too large)}: [t298 f32 [H=56
                                                                      W=56
    ...
    group g7 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n25 {derived verify=unproved (too large)}: [t148 f32 [H=56 W=56 C=64] {derived verify=unproved (too large)} ->[n178]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n178 {pt2=root[9] torch.ops.aten.add.Tensor verify=vacuous}: [t299 f32 [H=56
                                                                      W=56
                                                                      C=64] {derived verify=vacuous origins=0} ->[n179]] =
      add
        a=t148 {derived verify=unproved (too large)} <-n25
        b=t132 {derived verify=unproved (too large) origins=2} <-n176
    n179 {pt2=root[10] torch.ops.aten.relu.default verify=unproved (too large)}: [t300 f32 [H=56
                                                                      W=56
                                                                      C=64] {derived verify=unproved (too large)} ->[n31,
                                                                      n181]] =
      relu x=t299 {derived verify=vacuous origins=0} <-n178
    group g9 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n34 {derived verify=unproved (too large)}: [t157 f32 [H=56 W=56 C=64] {derived verify=unproved (too large)} ->[n180]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n180 {pt2=root[13] torch.ops.aten.relu.default verify=unproved (too large)}: [t301 f32 [H=56
                                                                      W=56
    ...
    group g11 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n42 {derived verify=unproved (too large)}: [t165 f32 [H=56 W=56 C=64] {derived verify=unproved (too large)} ->[n181]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n181 {pt2=root[16] torch.ops.aten.add.Tensor verify=vacuous}: [t302 f32 [H=56
                                                                      W=56
                                                                      C=64] {derived verify=vacuous origins=0} ->[n182]] =
      add
        a=t165 {derived verify=unproved (too large)} <-n42
        b=t300 {derived verify=unproved (too large)} <-n179
    n182 {pt2=root[17] torch.ops.aten.relu.default verify=unproved (too large)}: [t303 f32 [H=56
                                                                      W=56
                                                                      C=64] {derived verify=unproved (too large) origins=2} ->[n48,
                                                                      n63]] =
      relu x=t302 {derived verify=vacuous origins=0} <-n181
    group g13 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n51 {derived verify=unproved (too large)}: [t174 f32 [H=28 W=28 C=128] {derived verify=unproved (too large)} ->[n183]] =
        batch_norm
    ...
    group g17 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n66 {derived verify=unproved (too large)}: [t189 f32 [H=28 W=28 C=128] {derived verify=unproved (too large)} ->[n184]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n183 {pt2=root[20] torch.ops.aten.relu.default verify=unproved (too large)}: [t304 f32 [H=28
                                                                      W=28
    ...
    group g15 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n59 {derived verify=unproved (too large)}: [t182 f32 [H=28 W=28 C=128] {derived verify=unproved (too large)} ->[n184]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n184 {pt2=root[25] torch.ops.aten.add.Tensor verify=vacuous}: [t305 f32 [H=28
                                                                      W=28
                                                                      C=128] {derived verify=vacuous origins=0} ->[n185]] =
      add
        a=t182 {derived verify=unproved (too large)} <-n59
        b=t189 {derived verify=unproved (too large)} <-n66
    n185 {pt2=root[26] torch.ops.aten.relu.default verify=unproved (too large)}: [t306 f32 [H=28
                                                                      W=28
                                                                      C=128] {derived verify=unproved (too large)} ->[n72,
                                                                      n187]] =
      relu x=t305 {derived verify=vacuous origins=0} <-n184
    group g19 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n75 {derived verify=unproved (too large)}: [t198 f32 [H=28 W=28 C=128] {derived verify=unproved (too large)} ->[n186]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n186 {pt2=root[29] torch.ops.aten.relu.default verify=unproved (too large)}: [t307 f32 [H=28
                                                                      W=28
    ...
    group g21 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n83 {derived verify=unproved (too large)}: [t206 f32 [H=28 W=28 C=128] {derived verify=unproved (too large)} ->[n187]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n187 {pt2=root[32] torch.ops.aten.add.Tensor verify=vacuous}: [t308 f32 [H=28
                                                                      W=28
                                                                      C=128] {derived verify=vacuous origins=0} ->[n188]] =
      add
        a=t206 {derived verify=unproved (too large)} <-n83
        b=t306 {derived verify=unproved (too large)} <-n185
    n188 {pt2=root[33] torch.ops.aten.relu.default verify=unproved (too large)}: [t309 f32 [H=28
                                                                      W=28
                                                                      C=128] {derived verify=unproved (too large) origins=2} ->[n89,
                                                                      n104]] =
      relu x=t308 {derived verify=vacuous origins=0} <-n187
    group g23 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n92 {derived verify=unproved (too large)}: [t215 f32 [H=14 W=14 C=256] {derived verify=unproved (too large)} ->[n189]] =
        batch_norm
    ...
    group g27 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n107 {derived verify=unproved (too large)}: [t230 f32 [H=14 W=14 C=256] {derived verify=unproved (too large)} ->[n190]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n189 {pt2=root[36] torch.ops.aten.relu.default verify=unproved (too large)}: [t310 f32 [H=14
                                                                      W=14
    ...
    group g25 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n100 {derived verify=unproved (too large)}: [t223 f32 [H=14 W=14 C=256] {derived verify=unproved (too large)} ->[n190]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n190 {pt2=root[41] torch.ops.aten.add.Tensor verify=vacuous}: [t311 f32 [H=14
                                                                      W=14
                                                                      C=256] {derived verify=vacuous origins=0} ->[n191]] =
      add
        a=t223 {derived verify=unproved (too large)} <-n100
        b=t230 {derived verify=unproved (too large)} <-n107
    n191 {pt2=root[42] torch.ops.aten.relu.default verify=unproved (too large)}: [t312 f32 [H=14
                                                                      W=14
                                                                      C=256] {derived verify=unproved (too large)} ->[n113,
                                                                      n193]] =
      relu x=t311 {derived verify=vacuous origins=0} <-n190
    group g29 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n116 {derived verify=unproved (too large)}: [t239 f32 [H=14 W=14 C=256] {derived verify=unproved (too large)} ->[n192]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n192 {pt2=root[45] torch.ops.aten.relu.default verify=unproved (too large)}: [t313 f32 [H=14
                                                                      W=14
    ...
    group g31 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n124 {derived verify=unproved (too large)}: [t247 f32 [H=14 W=14 C=256] {derived verify=unproved (too large)} ->[n193]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n193 {pt2=root[48] torch.ops.aten.add.Tensor verify=vacuous}: [t314 f32 [H=14
                                                                      W=14
                                                                      C=256] {derived verify=vacuous origins=0} ->[n194]] =
      add
        a=t247 {derived verify=unproved (too large)} <-n124
        b=t312 {derived verify=unproved (too large)} <-n191
    n194 {pt2=root[49] torch.ops.aten.relu.default verify=unproved (too large)}: [t315 f32 [H=14
                                                                      W=14
                                                                      C=256] {derived verify=unproved (too large) origins=2} ->[n130,
                                                                      n145]] =
      relu x=t314 {derived verify=vacuous origins=0} <-n193
    group g33 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n133 {derived verify=unproved (too large)}: [t256 f32 [H=7 W=7 C=512] {derived verify=unproved (too large)} ->[n195]] =
        batch_norm
    ...
    group g37 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n148 {derived verify=unproved (too large)}: [t271 f32 [H=7 W=7 C=512] {derived verify=unproved (too large)} ->[n196]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n195 {pt2=root[52] torch.ops.aten.relu.default verify=unproved (too large)}: [t316 f32 [H=7
                                                                      W=7
    ...
    group g35 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n141 {derived verify=unproved (too large)}: [t264 f32 [H=7 W=7 C=512] {derived verify=unproved (too large)} ->[n196]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n196 {pt2=root[57] torch.ops.aten.add.Tensor verify=vacuous}: [t317 f32 [H=7
                                                                      W=7
                                                                      C=512] {derived verify=vacuous origins=0} ->[n197]] =
      add
        a=t264 {derived verify=unproved (too large)} <-n141
        b=t271 {derived verify=unproved (too large)} <-n148
    n197 {pt2=root[58] torch.ops.aten.relu.default verify=unproved (too large)}: [t318 f32 [H=7
                                                                      W=7
                                                                      C=512] {derived verify=unproved (too large)} ->[n154,
                                                                      n199]] =
      relu x=t317 {derived verify=vacuous origins=0} <-n196
    group g39 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n157 {derived verify=unproved (too large)}: [t280 f32 [H=7 W=7 C=512] {derived verify=unproved (too large)} ->[n198]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n198 {pt2=root[61] torch.ops.aten.relu.default verify=unproved (too large)}: [t319 f32 [H=7
                                                                      W=7
    ...
    group g41 torch.ops.aten._native_batch_norm_legit_no_training.default:
      n165 {derived verify=unproved (too large)}: [t288 f32 [H=7 W=7 C=512] {derived verify=unproved (too large)} ->[n199]] =
        batch_norm
          ...
          params={channel=C; eps=1e-05}
    n199 {pt2=root[64] torch.ops.aten.add.Tensor verify=vacuous}: [t320 f32 [H=7
                                                                      W=7
                                                                      C=512] {derived verify=vacuous origins=0} ->[n200]] =
      add
        a=t288 {derived verify=unproved (too large)} <-n165
        b=t318 {derived verify=unproved (too large)} <-n197
    n200 {pt2=root[65] torch.ops.aten.relu.default verify=vacuous}: [t321 f32 [H=7
                                                                      W=7
                                                                      C=512] {derived verify=vacuous origins=0} ->[n201]] =
      relu x=t320 {derived verify=vacuous origins=0} <-n199
    n201 {pt2=root[66] torch.ops.aten.mean.dim verify=unproved (over max_rounds) [sampled 4]}: [t322 f32 [C=512] {pt2=root:view verify=unproved (over max_rounds) [sampled 4]} ->[n173]] =
      mean
        x=t321 {derived verify=vacuous origins=0} <-n200
    ...
    group g42 torch.ops.aten.addmm.default:
      n173 {pt2=root[69] torch.ops.aten.addmm.default verify=proved (structural) [sampled 4]}: [t296 f32 [C=1000] {pt2=root:addmm verify=proved (structural) [sampled 4]}] =
        linear
          x=t322 {pt2=root:view verify=unproved (over max_rounds) [sampled 4]} <-n201
