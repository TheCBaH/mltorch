...
let%expect_test "bridge coverage" =
  ...
  [%expect
    ...
    step 1 [c]: {shape=[2,16,8,8] dims=[2,3] keepdim=false}
    [spec] torch.ops.aten.linalg_vector_norm.default: matched
    step 2 [n]: {shape=[2,16,8,8] dims=[2,3] keepdim=false}
    [spec] torch.ops.aten.linalg_vector_norm.default: matched
    step 3 [c]: {shape=[2,16,8,8] dims=[2,3] keepdim=false}
    [spec] torch.ops.aten.linalg_vector_norm.default: matched
    ...
    step 1 [value]: {shape=[1,4,8,8] value=float:2.5}
    [spec] torch.ops.aten.mul.Scalar: matched
    step 2 [c]: {shape=[1,3,8,8] value=float:2.5}
    [spec] torch.ops.aten.mul.Scalar: matched
    step 3 [h]: {shape=[1,3,8,8] value=float:2.5}
    [spec] torch.ops.aten.mul.Scalar: matched
    step 0: {shape=[2,4,8,8] pattern=equal}
    [spec] torch.ops.aten.mul.Tensor: matched
    step 1 [pattern]: {shape=[2,4,8,8] pattern=rhs[3]=1}
    [spec] torch.ops.aten.mul.Tensor: matched
    step 2 [n]: {shape=[2,4,8,8] pattern=rhs[3]=1}
    [spec] torch.ops.aten.mul.Tensor: matched
    step 3 [w]: {shape=[2,4,8,8] pattern=rhs[3]=1}
    [spec] torch.ops.aten.mul.Tensor: matched
    ...
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 2 [weight]: {input=[2,3,4] normalized=[4] eps=1e-06 weight=false bias=false cudnn=false}
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 3 [eps]: {input=[2,3,4] normalized=[4] eps=1e-05 weight=false bias=false cudnn=false}
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 0: {shape=[1,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 1 [c]: {shape=[1,2,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 2 [c]: {shape=[1,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 3 [h]: {shape=[1,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 0: {shape=[4,5] rank=2 dims=[0,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 1 [config]: {shape=[4,5] rank=2 dims=[0,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 2 [n]: {shape=[4,5] rank=2 dims=[0,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 3 [h]: {shape=[4,5] rank=2 dims=[0,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 0: {shape=[1,4,8,8] value=float:0.5}
    [spec] torch.ops.aten.pow.Tensor_Scalar: matched
    step 1 [h]: {shape=[1,4,4,8] value=float:0.5}
    [spec] torch.ops.aten.pow.Tensor_Scalar: matched
    ...
    step 1 [leading]: {input=[2,3,4] normalized=[4] eps=default weight=true bias=false cudnn=false}
    [spec] torch.ops.aten.rms_norm.default: matched
    step 2 [weight]: {input=[2,3,4] normalized=[4] eps=default weight=true bias=false cudnn=false}
    [spec] torch.ops.aten.rms_norm.default: matched
    step 3 [leading]: {input=[2,3,4,4] normalized=[4] eps=default weight=true bias=false cudnn=false}
    [spec] torch.ops.aten.rms_norm.default: matched
    step 0: {shape=[2,3,4,4]}
    ...
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 2 [e]: {batch=1 heads=2 sq=3 sk=4 e=3 mask=none scale=default}
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 3 [sk]: {batch=1 heads=2 sq=3 sk=4 e=3 mask=none scale=default}
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 0: {shape=[2,3,4,4]}
    ...
    [spec] torch.ops.aten.slice.Tensor: matched
    step 3 [h]: {shape=[4,3,2,5] dim=0 pattern=head [0,2) step=1}
    [spec] torch.ops.aten.slice.Tensor: matched
    ...
    [spec] torch.ops.aten.softmax.int: matched
    step 2 [h]: {shape=[2,4,8,8] dims=[3] keepdim=false}
    [spec] torch.ops.aten.softmax.int: matched
    step 3 [w]: {shape=[2,4,8,8] dims=[3] keepdim=false}
    [spec] torch.ops.aten.softmax.int: matched
    step 0: {shape=[2,4,8,8] pattern=equal}
    [spec] torch.ops.aten.sub.Tensor: matched
    step 1 [pattern]: {shape=[2,4,8,8] pattern=lhs[3]=1}
    [spec] torch.ops.aten.sub.Tensor: matched
    step 2 [n]: {shape=[4,4,8,8] pattern=lhs[3]=1}
    [spec] torch.ops.aten.sub.Tensor: matched
    step 3 [n]: {shape=[2,4,8,8] pattern=lhs[3]=1}
    [spec] torch.ops.aten.sub.Tensor: matched
    step 0: {shape=[2,4,8,8] dims=[2,3] keepdim=false}
    ...
    [spec] torch.ops.aten.sum.dim_IntList: matched
    step 3 [n]: {shape=[1,4,8,16] dims=[2,3] keepdim=false}
    [spec] torch.ops.aten.sum.dim_IntList: matched
    step 0: {shape=[4,5] rank=2 dims=(0,1)}
    [spec] torch.ops.aten.transpose.int: matched
    step 1 [h]: {shape=[4,5] rank=2 dims=(0,1)}
    [spec] torch.ops.aten.transpose.int: matched
    step 2 [h]: {shape=[2,5] rank=2 dims=(0,1)}
    [spec] torch.ops.aten.transpose.int: matched
    step 3 [config]: {shape=[3,2,5] rank=3 dims=(1,2)}
    [spec] torch.ops.aten.transpose.int: matched
    step 0: {shape=[2,3,4,4] dim=0}
    [spec] torch.ops.aten.unbind.int: matched
    step 1 [c]: {shape=[2,4,4,4] dim=0}
    [spec] torch.ops.aten.unbind.int: matched
    step 2 [n]: {shape=[2,4,4,4] dim=0}
    [spec] torch.ops.aten.unbind.int: matched
    step 3 [h]: {shape=[2,4,2,4] dim=0}
    [spec] torch.ops.aten.unbind.int: matched
    step 0: {shape=[1,4,4,4] pattern=flatten target=[64]}
    [spec] torch.ops.aten.view.default: matched
    step 1 [pattern]: {shape=[1,4,4,4] pattern=split_c target=[1,2,2,4,4]}
    [spec] torch.ops.aten.view.default: matched
    step 2 [n]: {shape=[1,4,4,4] pattern=split_c target=[1,2,2,4,4]}
    [spec] torch.ops.aten.view.default: matched
    step 3 [n]: {shape=[1,4,4,4] pattern=split_c target=[1,2,2,4,4]}
    [spec] torch.ops.aten.view.default: matched
    needs_meta:
