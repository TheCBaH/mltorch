(* Random-walk equivalence tests over the generated walk modules
   ...
   Per-op blocks pin a stable seed for the family-recipe ops; the
   every-generated-walk sweep and its [needs_meta] backlog are split into
   native_walk_coverage_test.ml (this file crossed the tracked 1000-line
   ceiling, scripts/check-file-size.sh). *)
