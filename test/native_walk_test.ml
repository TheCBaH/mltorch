...
let%expect_test "bridge coverage" =
  ...
  [%expect
    ...
    [spec] torch.ops.aten.hardtanh.default: matched
    step 2 [h]: {shape=[1,3,4,8] min=0 max=6}
    [spec] torch.ops.aten.hardtanh.default: matched
    step 3 [w]: {shape=[1,3,4,4] min=0 max=6}
    [spec] torch.ops.aten.hardtanh.default: matched
    step 0: {shape=[2,3,4,4]}
    ...
    [spec] torch.ops.aten.linalg_vector_norm.default: matched
    step 2 [keepdim]: {shape=[2,16,8,8] dims=[2,3] keepdim=false}
    [spec] torch.ops.aten.linalg_vector_norm.default: matched
    step 3 [dims]: {shape=[2,16,8,8] dims=[2,3] keepdim=false}
    [spec] torch.ops.aten.linalg_vector_norm.default: matched
    step 0: {input=[4,8] out_features=6 bias=true}
    [spec] torch.ops.aten.linear.default: matched
    ...
    step 1 [n]: {self=[5,4] other=[4,5]}
    [spec] torch.ops.aten.matmul.default: matched
    step 2 [m]: {self=[5,6] other=[6,5]}
    [spec] torch.ops.aten.matmul.default: matched
    step 3 [p]: {self=[5,6] other=[6,7]}
    [spec] torch.ops.aten.matmul.default: matched
    step 0: {kernel=2x2 stride=2x2 pad=0x0 n=1 c=4 H=8 W=8 ceil_mode=false}
    [spec] torch.ops.aten.max_pool2d.default: matched
    ...
    [spec] torch.ops.aten.mul.Scalar: matched
    step 2 [value]: {shape=[2,4,8,8] value=int:2}
    [spec] torch.ops.aten.mul.Scalar: matched
    ...
    [spec] torch.ops.aten.mul.Tensor: matched
    step 2 [c]: {shape=[2,4,8,8] pattern=equal}
    [spec] torch.ops.aten.mul.Tensor: matched
    step 3 [c]: {shape=[2,4,8,8] pattern=equal}
    [spec] torch.ops.aten.mul.Tensor: matched
    step 0: {input=[2,3,4] normalized=[4] eps=1e-06 weight=true bias=true cudnn=false}
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 1 [eps]: {input=[2,3,4] normalized=[4] eps=0 weight=true bias=true cudnn=false}
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 2 [normalized]: {input=[2,3,4] normalized=[4] eps=0 weight=true bias=true cudnn=false}
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 3 [leading]: {input=[2,3,4,4] normalized=[4] eps=0 weight=true bias=true cudnn=false}
    [spec] torch.ops.aten.native_layer_norm.default: matched
    step 0: {shape=[1,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 1 [n]: {shape=[2,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 2 [w]: {shape=[2,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 3 [c]: {shape=[2,3,4,4] pattern=const_w pad=[1,2] mode=constant value=0.1}
    [spec] torch.ops.aten.pad.default: matched
    step 0: {shape=[4,5] rank=2 dims=[0,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 1 [n]: {shape=[4,5] rank=2 dims=[0,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 2 [config]: {shape=[2,3,4,5] rank=4 dims=[0,2,3,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 3 [w]: {shape=[2,3,4,4] rank=4 dims=[0,2,3,1]}
    [spec] torch.ops.aten.permute.default: matched
    step 0: {shape=[1,4,8,8] value=float:0.5}
    [spec] torch.ops.aten.pow.Tensor_Scalar: matched
    step 1 [c]: {shape=[1,8,8,8] value=float:0.5}
    [spec] torch.ops.aten.pow.Tensor_Scalar: matched
    step 2 [w]: {shape=[1,8,8,8] value=float:0.5}
    [spec] torch.ops.aten.pow.Tensor_Scalar: matched
    step 3 [value]: {shape=[1,8,8,8] value=float:0.5}
    [spec] torch.ops.aten.pow.Tensor_Scalar: matched
    step 0: {shape=[2,3,4,4]}
    ...
    step 1 [eps]: {input=[2,3,4] normalized=[4] eps=1e-05 weight=true bias=false cudnn=false}
    [spec] torch.ops.aten.rms_norm.default: matched
    step 2 [leading]: {input=[2,4] normalized=[4] eps=1e-05 weight=true bias=false cudnn=false}
    [spec] torch.ops.aten.rms_norm.default: matched
    step 3 [weight]: {input=[2,4] normalized=[4] eps=1e-05 weight=true bias=false cudnn=false}
    [spec] torch.ops.aten.rms_norm.default: matched
    step 0: {shape=[2,3,4,4]}
    ...
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 1 [sk]: {batch=1 heads=2 sq=3 sk=6 e=5 mask=none scale=default}
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 2 [scale]: {batch=1 heads=2 sq=3 sk=6 e=5 mask=none scale=1}
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 3 [heads]: {batch=1 heads=1 sq=3 sk=6 e=5 mask=none scale=1}
    [spec] torch.ops.aten.scaled_dot_product_attention.default: matched
    step 0: {shape=[2,3,4,4]}
    ...
    [spec] torch.ops.aten.slice.Tensor: matched
    step 2 [h]: {shape=[2,3,2,5] dim=0 pattern=head [0,1) step=1}
    [spec] torch.ops.aten.slice.Tensor: matched
    step 3 [h]: {shape=[2,3,6,5] dim=0 pattern=head [0,1) step=1}
    [spec] torch.ops.aten.slice.Tensor: matched
    ...
    [spec] torch.ops.aten.softmax.int: matched
    step 2 [c]: {shape=[2,16,8,8] dims=[3] keepdim=false}
    [spec] torch.ops.aten.softmax.int: matched
    step 3 [dims]: {shape=[2,16,8,8] dims=[2] keepdim=false}
    [spec] torch.ops.aten.softmax.int: matched
    step 0: {shape=[2,4,8,8] pattern=equal}
