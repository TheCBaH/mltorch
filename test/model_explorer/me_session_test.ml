  ...
  List.map
    (fun k ->
      let status =
        ...
        | S.Capability.Feature S.Capability.Generated_js
...
let%expect_test "every key, and the payload each admits" =
  ...
  [%expect
    ...
    feature:generated_js          -             -             -             yes           yes           yes
    feature:loop_ir               -             -             -             -             -             -
    feature:codegen               -             -             -             -             -             - |}]
