...
let%expect_test "native walk coverage" =
  ...
  [%expect
    ...
    step 0: {shape=[n=1 c=8 h=1 w=4] out_features=6 bias=true}
    [native] linear: direct==symbolic
    step 1 [out_features]: {shape=[n=1 c=8 h=1 w=4] out_features=31 bias=true}
    [native] linear: direct==symbolic
    step 2 [bias]: {shape=[n=1 c=8 h=1 w=4] out_features=31 bias=true}
    [native] linear: direct==symbolic
    step 3 [out_features]: {shape=[n=1 c=8 h=1 w=4] out_features=13 bias=true}
    [native] linear: direct==symbolic
    step 4 [input]: {shape=[n=1 c=8 h=15 w=4] out_features=13 bias=true}
    [native] linear: direct==symbolic
    step 5 [out_features]: {shape=[n=1 c=8 h=15 w=4] out_features=2 bias=true}
    [native] linear: direct==symbolic
    step 0: {shape=[n=2 c=4 h=4 w=4] eps=1e-05}
    [native] batch_norm: direct==symbolic
    step 1 [eps]: {shape=[n=2 c=4 h=4 w=4] eps=0}
    [native] batch_norm: direct==symbolic
    step 2 [eps]: {shape=[n=2 c=4 h=4 w=4] eps=0}
    [native] batch_norm: direct==symbolic
    step 3 [input]: {shape=[n=2 c=4 h=15 w=4] eps=0}
    [native] batch_norm: direct==symbolic
    step 4 [input]: {shape=[n=2 c=4 h=15 w=11] eps=0}
    [native] batch_norm: direct==symbolic
    step 5 [input]: {shape=[n=2 c=4 h=11 w=11] eps=0}
    [native] batch_norm: direct==symbolic
    step 0: {shape=[n=1 c=5 h=4 w=3] k=1 eps=1e-05 weight=true}
    [native] rms_norm: direct==symbolic
    step 1 [input]: {shape=[n=1 c=5 h=4 w=16] k=1 eps=1e-05 weight=true}
    [native] rms_norm: direct==symbolic
    step 2 [input]: {shape=[n=1 c=8 h=4 w=16] k=1 eps=1e-05 weight=true}
    [native] rms_norm: direct==symbolic
    step 3 [weight]: {shape=[n=1 c=8 h=4 w=16] k=1 eps=1e-05 weight=true}
    [native] rms_norm: direct==symbolic
    step 4 [input]: {shape=[n=1 c=8 h=4 w=16] k=1 eps=1e-05 weight=true}
    [native] rms_norm: direct==symbolic
    step 5 [eps]: {shape=[n=1 c=8 h=4 w=16] k=1 eps=1e-05 weight=true}
    [native] rms_norm: direct==symbolic
    step 0: {shape=[n=1 c=5 h=4 w=3] k=1 eps=1e-05 weight=true bias=true}
    [native] layer_norm: direct==symbolic
    step 1 [k]: {shape=[n=1 c=5 h=4 w=3] k=1 eps=1e-05 weight=true bias=true}
    [native] layer_norm: direct==symbolic
    step 2 [eps]: {shape=[n=1 c=5 h=4 w=3] k=1 eps=0 weight=true bias=true}
    [native] layer_norm: direct==symbolic
    step 3 [input]: {shape=[n=1 c=8 h=4 w=3] k=1 eps=0 weight=true bias=true}
    [native] layer_norm: direct==symbolic
    step 4 [k]: {shape=[n=1 c=8 h=4 w=3] k=1 eps=0 weight=true bias=true}
    [native] layer_norm: direct==symbolic
    step 5 [input]: {shape=[n=2 c=8 h=4 w=3] k=1 eps=0 weight=true bias=true}
    [native] layer_norm: direct==symbolic
    ...
    [native] sdpa: direct==symbolic
    step 2 [wq]: {batch=1 heads=2 wq=5 wk=4 e=5 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 3 [wk]: {batch=1 heads=2 wq=5 wk=4 e=5 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 4 [wq]: {batch=1 heads=2 wq=1 wk=4 e=5 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 5 [batch]: {batch=2 heads=2 wq=1 wk=4 e=5 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 0: {shape=[n=1 c=4 h=8 w=8] kernel=2x2 stride=2x2 pad=0x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 1 [kernel]: {shape=[n=1 c=4 h=8 w=8] kernel=1x2 stride=2x2 pad=0x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 2 [input]: {shape=[n=2 c=4 h=8 w=8] kernel=1x2 stride=2x2 pad=0x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 3 [pad]: {shape=[n=2 c=4 h=8 w=8] kernel=1x2 stride=2x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 4 [stride]: {shape=[n=2 c=4 h=8 w=8] kernel=1x2 stride=3x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 5 [kernel]: {shape=[n=2 c=4 h=8 w=8] kernel=5x4 stride=3x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 0: {shape=[n=1 c=4 h=4 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 1 [input]: {shape=[n=1 c=4 h=9 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 2 [input]: {shape=[n=1 c=4 h=1 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 3 [input]: {shape=[n=1 c=4 h=1 w=16] -> flat}
    [native] reshape: direct==symbolic
    step 4 [input]: {shape=[n=1 c=31 h=1 w=16] -> flat}
    [native] reshape: direct==symbolic
    step 5 [input]: {shape=[n=1 c=19 h=1 w=16] -> flat}
    [native] reshape: direct==symbolic
    step 0: {shape=[n=1 c=4 h=4 w=4] perm=[H<-W, W<-H]}
    [native] permute: direct==symbolic
    step 1 [input]: {shape=[n=1 c=4 h=4 w=15] perm=[H<-W, W<-H]}
    [native] permute: direct==symbolic
    step 2 [perm]: {shape=[n=1 c=4 h=4 w=15] perm=[H<-C, W<-H, C<-W]}
    [native] permute: direct==symbolic
    step 3 [perm]: {shape=[n=1 c=4 h=4 w=15] perm=[H<-C, C<-H]}
    [native] permute: direct==symbolic
    step 4 [perm]: {shape=[n=1 c=4 h=4 w=15] perm=[H<-C, W<-H, C<-W]}
    [native] permute: direct==symbolic
    step 5 [perm]: {shape=[n=1 c=4 h=4 w=15] perm=[W<-C, C<-W]}
    [native] permute: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 1 [input]: [n=1 c=3 h=4 w=16] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 2 [input]: [n=1 c=3 h=4 w=1] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 3 [input]: [n=1 c=3 h=4 w=14] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 4 [bounds]: [n=1 c=3 h=4 w=14] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 5 [input]: [n=1 c=12 h=4 w=14] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    [native] clone: direct==symbolic
    step 1 [input]: [n=1 c=6 h=4 w=4]
    [native] clone: direct==symbolic
    step 2 [input]: [n=1 c=12 h=4 w=4]
    [native] clone: direct==symbolic
    step 3 [input]: [n=1 c=12 h=4 w=5]
    [native] clone: direct==symbolic
    step 4 [input]: [n=1 c=12 h=5 w=5]
    [native] clone: direct==symbolic
    step 5 [input]: [n=1 c=12 h=5 w=7]
    [native] clone: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4] {min_val=0; max_val=6}
    [native] hardtanh: direct==symbolic
    step 1 [input]: [n=1 c=17 h=4 w=4] {min_val=0; max_val=6}
    [native] hardtanh: direct==symbolic
    step 2 [bounds]: [n=1 c=17 h=4 w=4] {min_val=1; max_val=-1}
    [native] hardtanh: direct==symbolic
    step 3 [input]: [n=1 c=17 h=8 w=4] {min_val=1; max_val=-1}
    [native] hardtanh: direct==symbolic
    step 4 [bounds]: [n=1 c=17 h=8 w=4] {min_val=1; max_val=-1}
    [native] hardtanh: direct==symbolic
    step 5 [input]: [n=1 c=17 h=7 w=4] {min_val=1; max_val=-1}
    [native] hardtanh: direct==symbolic
    ...
    step 1 [input]: {shape=[n=2 c=4 h=4 w=14] axis=H}
    [native] unbind: direct==symbolic
    step 2 [axis]: {shape=[n=2 c=4 h=4 w=14] axis=W}
    [native] unbind: direct==symbolic
    step 3 [axis]: {shape=[n=2 c=4 h=4 w=14] axis=H}
    [native] unbind: direct==symbolic
    step 4 [axis]: {shape=[n=2 c=4 h=4 w=14] axis=W}
    [native] unbind: direct==symbolic
    step 5 [input]: {shape=[n=2 c=4 h=4 w=11] axis=W}
    [native] unbind: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    ...
    step 1 [approximate]: [n=1 c=3 h=4 w=4] tanh
    [native] gelu: direct==symbolic
    step 2 [approximate]: [n=1 c=3 h=4 w=4] none
    [native] gelu: direct==symbolic
    step 3 [approximate]: [n=1 c=3 h=4 w=4] none
    [native] gelu: direct==symbolic
    step 4 [input]: [n=1 c=21 h=4 w=4] none
    [native] gelu: direct==symbolic
    step 5 [input]: [n=2 c=21 h=4 w=4] none
    [native] gelu: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4] scalar=3
    ...
    step 1 [input]: {shape=[n=2 c=25 h=4 w=4] axis=H start=0 stop=2 step=1}
    [native] slice: direct==symbolic
    step 2 [axis]: {shape=[n=2 c=25 h=4 w=4] axis=W start=0 stop=2 step=1}
    [native] slice: direct==symbolic
    step 3 [pattern]: {shape=[n=2 c=25 h=4 w=4] axis=W start=0 stop=4 step=3}
    [native] slice: direct==symbolic
    step 4 [axis]: {shape=[n=2 c=25 h=4 w=4] axis=H start=0 stop=4 step=3}
    [native] slice: direct==symbolic
    step 5 [axis]: {shape=[n=2 c=25 h=4 w=4] axis=N start=0 stop=2 step=3}
    [native] slice: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    [native] div: direct==symbolic
    step 1 [input]: [n=1 c=3 h=4 w=4]
    [native] div: direct==symbolic
    step 2 [input]: [n=1 c=2 h=4 w=4]
    [native] div: direct==symbolic
    step 3 [input]: [n=1 c=2 h=4 w=12]
    [native] div: direct==symbolic
    step 4 [input]: [n=1 c=4 h=4 w=12]
    [native] div: direct==symbolic
    step 5 [input]: [n=1 c=4 h=4 w=12]
    [native] div: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    ...
    [native] bmm: direct==symbolic
    step 2 [n]: {batch=2 n=8 m=3 p=4}
    [native] bmm: direct==symbolic
    step 3 [m]: {batch=2 n=8 m=8 p=4}
    [native] bmm: direct==symbolic
    step 4 [batch]: {batch=2 n=8 m=8 p=4}
    [native] bmm: direct==symbolic
    step 5 [n]: {batch=2 n=5 m=8 p=4}
    [native] bmm: direct==symbolic
    step 0: {shape=[1,4,8,8] output_size=[4,4]}
    [native] adaptive_avg_pool2d: direct==symbolic
    step 1 [out_w]: {shape=[1,4,8,8] output_size=[4,5]}
    [native] adaptive_avg_pool2d: direct==symbolic
    step 2 [c]: {shape=[1,4,8,8] output_size=[4,5]}
    [native] adaptive_avg_pool2d: direct==symbolic
    step 3 [out_h]: {shape=[1,4,8,8] output_size=[2,5]}
    [native] adaptive_avg_pool2d: direct==symbolic
    step 4 [n]: {shape=[2,4,8,8] output_size=[2,5]}
    [native] adaptive_avg_pool2d: direct==symbolic
    step 5 [out_w]: {shape=[2,4,8,8] output_size=[2,2]}
    [native] adaptive_avg_pool2d: direct==symbolic |}]
