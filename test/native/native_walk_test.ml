...
let%expect_test "native walk coverage" =
  ...
  [%expect
    ...
    [native] layer_norm: direct==symbolic
    step 2 [k]: {shape=[n=1 c=5 h=4 w=3] k=1 eps=1e-05 weight=false bias=true}
    [native] layer_norm: direct==symbolic
    step 3 [bias]: {shape=[n=1 c=5 h=4 w=3] k=1 eps=1e-05 weight=false bias=false}
    [native] layer_norm: direct==symbolic
    step 4 [input]: {shape=[n=1 c=5 h=4 w=3] k=1 eps=1e-05 weight=false bias=false}
    [native] layer_norm: direct==symbolic
    step 5 [k]: {shape=[n=1 c=5 h=4 w=3] k=2 eps=1e-05 weight=false bias=false}
    [native] layer_norm: direct==symbolic
    step 0: {shape=[n=1 c=4 h=8 w=8] kernel=2x2 stride=2x2 pad=0x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 1 [kernel]: {shape=[n=1 c=4 h=8 w=8] kernel=2x5 stride=2x2 pad=0x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 2 [pad]: {shape=[n=1 c=4 h=8 w=8] kernel=2x5 stride=2x2 pad=1x2}
    [native] max_pool2d_with_indices: direct==symbolic
    step 3 [stride]: {shape=[n=1 c=4 h=8 w=8] kernel=2x5 stride=1x2 pad=1x2}
    [native] max_pool2d_with_indices: direct==symbolic
    step 4 [stride]: {shape=[n=1 c=4 h=8 w=8] kernel=2x5 stride=2x3 pad=1x2}
    [native] max_pool2d_with_indices: direct==symbolic
    step 5 [kernel]: {shape=[n=1 c=4 h=8 w=8] kernel=5x1 stride=2x3 pad=1x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 0: {shape=[n=1 c=4 h=4 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 1 [input]: {shape=[n=1 c=4 h=1 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 2 [input]: {shape=[n=1 c=4 h=3 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 3 [input]: {shape=[n=1 c=1 h=3 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 4 [input]: {shape=[n=1 c=1 h=15 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 5 [input]: {shape=[n=1 c=1 h=15 w=12] -> flat}
    [native] reshape: direct==symbolic
    ...
    [native] permute: direct==symbolic
    step 3 [perm]: {shape=[n=1 c=4 h=4 w=4] perm=[H<-W, W<-C, C<-H]}
    [native] permute: direct==symbolic
    step 4 [input]: {shape=[n=1 c=4 h=4 w=6] perm=[H<-W, W<-C, C<-H]}
    [native] permute: direct==symbolic
    step 5 [input]: {shape=[n=1 c=4 h=4 w=12] perm=[H<-W, W<-C, C<-H]}
    [native] permute: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4] {min=0; max=6}
    [native] clamp: direct==symbolic
    step 1 [bounds]: [n=1 c=3 h=4 w=4] {min=nan; max=1}
    [native] clamp: direct==symbolic
    step 2 [input]: [n=1 c=3 h=15 w=4] {min=nan; max=1}
    [native] clamp: direct==symbolic
    step 3 [bounds]: [n=1 c=3 h=15 w=4] {min=0; max=none}
    [native] clamp: direct==symbolic
    step 4 [bounds]: [n=1 c=3 h=15 w=4] {min=0; max=nan}
    [native] clamp: direct==symbolic
    step 5 [bounds]: [n=1 c=3 h=15 w=4] {min=1; max=-1}
    [native] clamp: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    ...
    step 1 [input]: [n=1 c=17 h=4 w=4] scalar=3
    [native] div_scalar: direct==symbolic
    step 2 [scalar]: [n=1 c=17 h=4 w=4] scalar=0.5
    [native] div_scalar: direct==symbolic
    step 3 [input]: [n=1 c=17 h=8 w=4] scalar=0.5
    [native] div_scalar: direct==symbolic
    step 4 [scalar]: [n=1 c=17 h=8 w=4] scalar=3
    [native] div_scalar: direct==symbolic
    step 5 [input]: [n=1 c=17 h=7 w=4] scalar=3
    [native] div_scalar: direct==symbolic
    ...
    [native] unbind: direct==symbolic
    step 3 [axis]: {shape=[n=2 c=4 h=4 w=4] axis=W}
    [native] unbind: direct==symbolic
    step 4 [input]: {shape=[n=2 c=4 h=8 w=4] axis=W}
    [native] unbind: direct==symbolic
    step 5 [input]: {shape=[n=2 c=4 h=7 w=4] axis=W}
    [native] unbind: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    ...
    step 1 [input]: {shape=[n=2 c=4 h=9 w=4] axis=H start=0 stop=4 step=1}
    [native] slice: direct==symbolic
    step 2 [axis]: {shape=[n=2 c=4 h=9 w=4] axis=N start=0 stop=1 step=1}
    [native] slice: direct==symbolic
    step 3 [input]: {shape=[n=1 c=4 h=9 w=4] axis=N start=0 stop=1 step=1}
    [native] slice: direct==symbolic
    step 4 [pattern]: {shape=[n=1 c=4 h=9 w=4] axis=N start=0 stop=1 step=3}
    [native] slice: direct==symbolic
    step 5 [input]: {shape=[n=1 c=31 h=9 w=4] axis=N start=0 stop=1 step=3}
    [native] slice: direct==symbolic |}]
