...
let%expect_test "native walk coverage" =
  ...
  [%expect
    ...
    [native] sdpa: direct==symbolic
    step 2 [wk]: {batch=1 heads=2 wq=3 wk=2 e=5 mask=absent scale=default}
    [native] sdpa: direct==symbolic
    step 3 [mask]: {batch=1 heads=2 wq=3 wk=2 e=5 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 4 [e]: {batch=1 heads=2 wq=3 wk=2 e=3 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 5 [wk]: {batch=1 heads=2 wq=3 wk=1 e=3 mask=present scale=default}
    [native] sdpa: direct==symbolic
    step 0: {shape=[n=1 c=4 h=8 w=8] kernel=2x2 stride=2x2 pad=0x0}
    [native] max_pool2d_with_indices: direct==symbolic
    step 1 [pad]: {shape=[n=1 c=4 h=8 w=8] kernel=2x2 stride=2x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 2 [input]: {shape=[n=1 c=31 h=8 w=8] kernel=2x2 stride=2x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 3 [kernel]: {shape=[n=1 c=31 h=8 w=8] kernel=3x4 stride=2x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 4 [input]: {shape=[n=2 c=31 h=8 w=8] kernel=3x4 stride=2x2 pad=0x1}
    [native] max_pool2d_with_indices: direct==symbolic
    step 5 [pad]: {shape=[n=2 c=31 h=8 w=8] kernel=3x4 stride=2x2 pad=0x2}
    [native] max_pool2d_with_indices: direct==symbolic
    step 0: {shape=[n=1 c=4 h=4 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 1 [input]: {shape=[n=1 c=4 h=4 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 2 [input]: {shape=[n=1 c=4 h=5 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 3 [input]: {shape=[n=1 c=26 h=5 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 4 [input]: {shape=[n=2 c=26 h=5 w=4] -> flat}
    [native] reshape: direct==symbolic
    step 5 [input]: {shape=[n=2 c=26 h=5 w=12] -> flat}
    [native] reshape: direct==symbolic
    step 0: {shape=[n=1 c=4 h=4 w=4] perm=[H<-W, W<-H]}
    [native] permute: direct==symbolic
    step 1 [input]: {shape=[n=1 c=4 h=9 w=4] perm=[H<-W, W<-H]}
    [native] permute: direct==symbolic
    step 2 [perm]: {shape=[n=1 c=4 h=9 w=4] perm=[H<-C, W<-H, C<-W]}
    [native] permute: direct==symbolic
    step 3 [input]: {shape=[n=1 c=4 h=9 w=4] perm=[H<-C, W<-H, C<-W]}
    [native] permute: direct==symbolic
    step 4 [perm]: {shape=[n=1 c=4 h=9 w=4] perm=[H<-W, W<-C, C<-H]}
    [native] permute: direct==symbolic
    step 5 [perm]: {shape=[n=1 c=4 h=9 w=4] perm=[W<-C, C<-W]}
    [native] permute: direct==symbolic
    ...
    [native] clamp: direct==symbolic
    step 3 [input]: [n=1 c=3 h=4 w=15] {min=-1; max=1}
    [native] clamp: direct==symbolic
    step 4 [input]: [n=1 c=3 h=16 w=15] {min=-1; max=1}
    [native] clamp: direct==symbolic
    step 5 [input]: [n=2 c=3 h=16 w=15] {min=-1; max=1}
    [native] clamp: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
    ...
    [native] unbind: direct==symbolic
    step 2 [input]: {shape=[n=2 c=4 h=9 w=14] axis=H}
    [native] unbind: direct==symbolic
    step 3 [axis]: {shape=[n=2 c=4 h=9 w=14] axis=N}
    [native] unbind: direct==symbolic
    step 4 [axis]: {shape=[n=2 c=4 h=9 w=14] axis=N}
    [native] unbind: direct==symbolic
    step 5 [axis]: {shape=[n=2 c=4 h=9 w=14] axis=H}
    [native] unbind: direct==symbolic
    step 0: [n=1 c=3 h=4 w=4]
