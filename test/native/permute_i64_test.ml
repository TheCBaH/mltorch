(* [Eval_direct]'s dtype-preserving [Permute] dispatch (P5.2 follow-up to
   Reshape's own commit `d17e30fa`): the default [Permute.Compute(S).pixel]
   ...
   of that commit, [Permute] had NO dispatch arm of its own at all, so this
   ...
   whose builder-side gap was found and fixed in a later session). See the
