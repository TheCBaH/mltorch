(* [Eval_symbolic]'s own P5.4 mixed-dtype rejection, the Symbolic twin of
   ...
   the exact defect class Direct's own [e2a0cddc] fix closed there. This does
   NOT add I64,I64 dispatch to Symbolic (still Direct-only, see the
   implementation tracker's P5.6 note) -- the matching-format cases below
