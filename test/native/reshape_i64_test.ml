(* [Eval_direct]'s dtype-preserving [Reshape] dispatch: the default
   [Reshape.Reshape.Compute(Direct).pixel] arm reads
   ...
   [Tensor.read_i64_at6] instead -- never touching float. *)
