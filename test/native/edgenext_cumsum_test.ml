(* Gate 7 item 1: a minimal fixture reproducing EdgeNeXt's
   ...
   differential coverage are explicitly NOT part of this entry -- see the
   implementation tracker's Gate 7 entry for the itemized remainder. *)
...
let%expect_test
  ...
  (* [mask]/[inv] are genuine Bool storage (P6.3), not F32-encoded 0./1. --
