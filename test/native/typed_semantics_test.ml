(* Exercises [Semantics.TYPED_SEMANTICS] (semantics.ml), Direct's and
   Symbolic's new instances of it (direct.ml/symbolic.ml) -- Gate 3's P3.1
   ("typed Direct/Symbolic semantics and checked operation dispatch"). Follows
   ...
   ground_eval_i64_ground_test.ml) -- grounding an I64 expression is P4 scope,
   not this gate's. *)
