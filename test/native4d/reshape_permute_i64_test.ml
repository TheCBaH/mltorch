(* [Eval_direct4]'s dtype-preserving [Reshape4]/[Permute4] dispatch, the
   Native4D twin of [Eval_direct]'s own fix (`reshape_i64_test.ml`/
   ...
   instead -- never touching float. Native4D is a required execution route, and
   this pair had no I64 dispatch at all before. *)
