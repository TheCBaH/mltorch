(* Shared evaluator plumbing, split out of [eval.ml] (tail-call conversion
   Stage 2; see .ai/): everything [value] depends on but does not itself
   define. Moved verbatim -- no algorithm here changed. *)
