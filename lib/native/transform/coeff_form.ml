...
let rec of_ground (e : Ground_expr.t) : t =
  ...
  | Ground_expr.Binary (Expr.Add, a, b) -> add (of_ground a) (of_ground b)
  | Ground_expr.Binary (Expr.Sub, a, b) -> sub (of_ground a) (of_ground b)
  | Ground_expr.Binary (Expr.Mul, a, b) -> mul (of_ground a) (of_ground b)
  | Ground_expr.Binary (Expr.Div, a, b) -> (
