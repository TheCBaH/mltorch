(* [int64 Expr.Value.t] counterpart of [Region_local.t]: scalar/vector Region
   ...
   work, not this module's (see the implementation tracker's P3.2 remainder
   note).
   ...
   [.vector]/[.scan] and [Region_program.Builder]) is source-unchanged -- see
   the implementation tracker's D08 note. *)
