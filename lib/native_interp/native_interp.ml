...
module Bad_repeat = Native_interp_error.Bad_repeat
module Bad_slice = Native_interp_error.Bad_slice
module Bad_tile = Native_interp_error.Bad_tile
...
module Einsum_unsupported = Native_interp_error.Einsum_unsupported
module Index_list = Native_interp_error.Index_list
